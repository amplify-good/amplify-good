...
import type { DbMusicianWithLinks } from '@/lib/db/types'
...
export default function BookingForm({ musician }: { musician: DbMusicianWithLinks }) {
  ...
  const baseRate =
    musician.rate_type === 'hourly' ? musician.rate * durationHours : musician.rate
      ...
      <section className="bg-parchment py-10 px-4 border-b-2 border-gold">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="font-body text-gray-600 mt-2 max-w-lg">
            Fill out your event details and we&apos;ll send a booking request to the
            musician. 15% of every booking goes directly to non-profit impact.
          </p>
        </div>
      </section>
      ...
      {submitted ? (
        ...
        <div className="max-w-xl mx-auto card text-center py-12 px-8">
          ...
          <p className="font-body text-sm text-gray-400 mt-3">
            You can track the status of this booking on your dashboard.
          </p>
            ...
            <div className="card flex flex-col items-center text-center gap-4 sticky top-24">
              ...
              {!musician.available && (
                <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-xl">
                  <p className="text-sm text-red-700 font-body font-semibold">
                    This musician is currently unavailable for bookings.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="card">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="bg-sand-light rounded-2xl p-5 border border-sand-dark">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="impact-number text-xl">${baseRate.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-body text-sm text-gray-600">
                ...
                <button
                  type="submit"
                  disabled={isLoading || !musician.available}
                  className="btn-primary w-full text-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {!musician.available
                    ? 'Musician Unavailable'
                    : isLoading
                      ? 'Sending…'
                      : 'Confirm Booking'}
                </button>
